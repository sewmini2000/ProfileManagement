...
import com.example.profilemanagement.Models.OrderedItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(OrderedFoodList.this, R.layout.custom_ordered_item_deails, (ArrayList<OrderedItems>) user);
    ...
    class MyAdapter extends ArrayAdapter<OrderedItems> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(R.layout.custom_ordered_item_deails, null);
                    ...
                    final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Toast.makeText(myContext, "Order deleted successfully", Toast.LENGTH_SHORT).show();
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.equals("")) {
                                ...
                                Toast.makeText(OrderedFoodList.this, "Order Updated successfully", Toast.LENGTH_SHORT).show();
