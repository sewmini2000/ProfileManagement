    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SellerProfile.this);

                View view1 = LayoutInflater.from(SellerProfile.this).inflate(R.layout.update_profile,null);
                ...
                textView2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MDToast mdToast = MDToast.makeText(SellerProfile.this, "You Can't update your Email", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR);
                        mdToast.show();
                ...
                textViewp.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MDToast mdToast = MDToast.makeText(SellerProfile.this, "You Can't update your Password", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR);
                        mdToast.show();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(Name.isEmpty()) {
                            ...
                            MDToast mdToast = MDToast.makeText(SellerProfile.this, "Profile Updated Successfully", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS);
                            mdToast.show();
